...
export default function TeacherDashboard({ teacher }: { teacher: Teacher }) {
  ...
  return (
    <Theme accentColor="red">
      <Flex direction="row">
        <Flex className="md:w-[27%] lg:w-[20%] xl:w-[16%]">
          <Flex
            direction="column"
        ...
        <Flex className="md:w-[43%] lg:w-[60%] xl:w-[68%]" justify="center">
          <Flex direction="column" className="w-1/2 py-4">
            ...
            <Flex direction="column" gap="9">
                        ...
                        <Flex direction="column">
                                ...
                                <Flex className="pr-2" gap="2">
                                  ...
                                  >
                                    ...
                                    {request.isCompleted &&
                                      !request.isAccepted &&
                                      'رد شده'}
                                    {!request.isCompleted && 'در انتظار بررسی'}
                                  </Badge>
                                </Flex>
                              </Flex>
                          ...
                          >
                            {request.studentPreqsGrades.length > 0 &&
                              request.studentPreqsGrades.map((preq, index) => (
              ...
              {requests.length === 0 && (
                <Heading>در حال حاضر درخواستی برای این درس وجود ندارد.</Heading>
              )}
            </Flex>
          </Flex>
        </Flex>
